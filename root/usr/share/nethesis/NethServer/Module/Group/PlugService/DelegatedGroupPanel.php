...
/**
 * delegated panel Group plugin
 *
 * @author Stephane de Labrusse <stephdl@de-labrusse.fr>
 */

class DelegatedGroupPanel extends \Nethgui\Controller\Table\RowPluginAction
{
    ...
    protected function initializeAttributes(\Nethgui\Module\ModuleAttributesInterface $base)
    {
        ...
        return \Nethgui\Module\SimpleModuleAttributesProvider::extendModuleAttributes($base, 'DelegatedGroupPanel', 20);
    }
